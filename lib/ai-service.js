...
async function callOpenAI(promptOrMessages, model, maxTokens, retries, timeoutMs) {
  ...
  while (retries > 0) {
    try {
      ...
      // Some newer models (o1, o3, GPT-5 family) require max_completion_tokens instead of max_tokens
      ...
      // Some models (o1, o3, GPT-5 family) don't support temperature parameter - must use default (1) or omit it
